...
<div class="legend">
  ...
  <label><input type="checkbox" id="locToggle" checked/> Show my location</label>
  ...
  <div id="locStatus" style="margin-top:2px; color:#666; font-size:11px; min-height:14px;"></div>
</div>
<div id="map"></div>
<script>
